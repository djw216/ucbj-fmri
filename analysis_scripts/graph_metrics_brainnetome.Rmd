---
title: "Mixed effects models for Brainnetome Atlas"
...
data.spreadsh = "data_source/graph_metrics_brainnetome.csv"
...
###for controls
mod=lmer(scale(degree) ~ scale(ucbj) +scale(Age_at_fmri) +scale(dvars_mean) +scale(cortical) +scale(Sex)+ (1 | SubID) +(1| region), data=subset(combined_file, Group=="Control"))
