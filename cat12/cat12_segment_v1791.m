function cat12_segment_v1791(ref)
%This version of CAT12 uses MNI template templates_MNI152NLin2009cAsym
...
%addpath('/rds/project/rds-k1PgZFWfeZY/applications/spm/cat12/cat12_1791/')

%disp(['Reference images is ' ref]);

%-----------------------------------------------------------------------
% Job saved on 12-Apr-2022 21:22:39 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{1}.spm.tools.cat.estwrite.opts.biasacc = 1.0;  %Default 0.5
...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.WMHC = 3; %Default WMH correction with no output = 2, 1=WMH temp, 0=No WMH correction. But error says if < 3 then no output WMH possible
%matlabbatch{1}.spm.tools.cat.estwrite.extopts.registration.shooting.shootingtpm = {'/rds/project/rds-k1PgZFWfeZY/applications/spm/spm12_7771/toolbox/cat12/templates_MNI152NLin2009cAsym/Template_0_GS.nii'};
matlabbatch{1}.spm.tools.cat.estwrite.extopts.registration.shooting.shootingtpm = {'/rds/project/rds-k1PgZFWfeZY/applications/spm/spm12_7771/toolbox/cat12/templates_MNI152NLin2009cAsym/Template_0_GS.nii'};
matlabbatch{1}.spm.tools.cat.estwrite.extopts.registration.shooting.regstr = 0.5;
matlabbatch{1}.spm.tools.cat.estwrite.extopts.vox = 2;
...
%It is no longer necessary to specify expert options and the bias settings can also be applied using switches above 
