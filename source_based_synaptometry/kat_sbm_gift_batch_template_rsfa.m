...
icasso_opts.num_ica_runs = <NUM_ICASSO_RUNS>;      % Number of times ICA will be run
...
maskFile = <MASK_FILE>;
% maskFile = '/imaging/camcan/sandbox/kt03/fmri/masks/Brain_mask_dartelmni_61x73x61.nii';
